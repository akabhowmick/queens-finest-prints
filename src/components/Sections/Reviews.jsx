...
class Reviews extends React.Component {
  ...
  goToNum = (newCurrent) => {
    ...
    // Use setState to update the state variables
    this.setState(
      (prevState) => ({
        current: newCurrent,
        next: newCurrent < slidesDummy.length - 1 ? newCurrent + 1 : 0,
        prev: newCurrent > 0 ? newCurrent - 1 : slidesDummy.length - 1,
      }),
      () => {
        // Use the callback to ensure state is updated before updating the carousel CSS
  ...
  goToNext = () =>
    this.state.current < this.state.slides - 1
      ? this.goToNum(this.state.current + 1)
      : this.goToNum(0);
  goToPrev = () =>
    this.state.current > 0
      ? this.goToNum(this.state.current - 1)
      : this.goToNum(this.state.slides - 1);
          ...
          <div className="review-carosel">
            <div className="review-item active">
              ...
              <div className="review-text">
                ...
                the ok to everything before making it. Turned out just the way I imagined! There was
                a little bit of product build up at the end of the design, but other than that, I
                absolutely love it. Can’t wait to give it to my boyfriend for his bday!
              </div>
            </div>
            <div className="review-item next">
              ...
              <div className="review-text">
                #2 This is awesome to show off my cards on the page! The detail is amazing! Glad to
                have found such a great source!
              </div>
            </div>
            ...
            <div className="review-item prev">
              ...
              <div className="review-text">#4 10/10 would recommend!</div>
            </div>
          </div>
